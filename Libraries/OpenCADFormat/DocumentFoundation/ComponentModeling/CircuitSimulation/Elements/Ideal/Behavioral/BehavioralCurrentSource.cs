...
{
    public class BehavioralCurrentSource : BehavioralElement
    {
        public BehavioralCurrentSource(Parameter inputParameter, string responseFunction, string name) : base(name)
        {

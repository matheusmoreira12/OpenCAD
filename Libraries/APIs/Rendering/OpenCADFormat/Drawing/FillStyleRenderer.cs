...
{
    public sealed class FillStyleRenderer : Renderer<OpenCAD.OpenCADFormat.Drawing.FillStyle>
    {
        public FillStyleRenderer(OpenCAD.OpenCADFormat.Drawing.FillStyle target) : base(target)
        {
        }
